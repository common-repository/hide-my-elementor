...
if (!class_exists('Hide_Elementor_Functions')) {

	class Hide_Elementor_Functions {
		...
		public function elementor_mod_rewrite_rules($rules) {
			...
			if (!isset($_GET['elementor-preview'])) {
				$he_upload_path = "wp-content/uploads/{$he_slug}/css";
				$he_rules = PHP_EOL . "#BEGIN - Hide Elementor Rules" . PHP_EOL
					. "<IfModule mod_rewrite.c>" . PHP_EOL
					. "RewriteEngine On" . PHP_EOL
					. "RewriteCond %{THE_REQUEST} ^GET\ /wp-content/plugins/{$he_slug}/assets/" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}/assets/(.*).js index.php?he_wrapper_js=wp-content/plugins/elementor/assets/$1.js" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}/assets/(.*).css index.php?he_wrapper_css=wp-content/plugins/elementor/assets/$1.css" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}/assets/(.*).woff wp-content/plugins/elementor/assets/$1.woff" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}/assets/(.*).png wp-content/plugins/elementor/assets/$1.png" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}-pro/assets/(.*).js index.php?he_wrapper_js=wp-content/plugins/elementor-pro/assets/$1.js" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}-pro/assets/(.*).css index.php?he_wrapper_css=wp-content/plugins/elementor-pro/assets/$1.css" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}-pro/assets/(.*).woff wp-content/plugins/elementor-pro/assets/$1.woff" . PHP_EOL
					. "RewriteRule ^wp-content/plugins/{$he_slug}-pro/assets/(.*).png wp-content/plugins/elementor-pro/assets/$1.png" . PHP_EOL
					. "RewriteRule ^{$he_upload_path}/global\.css /index\.php?he_wrapper_css=wp-content/uploads/elementor/css/global\.css" . PHP_EOL
					. "RewriteRule ^{$he_upload_path}/post-([0-9-_\\.]+)\.css /index\.php?he_wrapper_css=wp-content/uploads/elementor/css/post-$1\.css" . PHP_EOL
					. "</IfModule>" . PHP_EOL
...
global $Hide_Elementor_Functions;
$Hide_Elementor_Functions = new Hide_Elementor_Functions();
